...
import com.niyaj.popos.features.account.presentation.register.components.login_info.LoginInfo
import com.niyaj.popos.features.account.presentation.register.components.login_info.LoginInfoEvent
import com.niyaj.popos.features.account.presentation.register.components.registration_result.RegistrationResult
            ...
            scope.launch {
                if (result) {
                    ...
                    viewModel.onBasicInfoEvent(
                        BasicInfoEvent.PrintLogoChanged(
                            RESTAURANT_PRINT_LOGO_NAME
                        )
                    )
