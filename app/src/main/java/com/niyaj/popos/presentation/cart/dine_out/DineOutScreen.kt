                        ...
                        if(cartItem.cartOrder != null && cartItem.cartProducts.isNotEmpty()) {
                            ...
                            Card(
                                modifier = Modifier
                                    ...
                                    .clickable {
                                        dineOutViewModel.onDineOutEvent(DineOutEvent.SelectDineOutOrder(
                                ...
                                Column(
                                    ...
                                    CartItemOrderDetailsSection(
                                        ...
                                        onClick = {
                                            dineOutViewModel.onDineOutEvent(DineOutEvent.SelectDineOutOrder(cartItem.cartOrder.cartOrderId))
                                        },
                                        onEditClick = {
                                    ...
                                    CartItemProductDetailsSection(
                                        ...
                                        decreaseQuantity = {
                                            dineOutViewModel.onDineOutEvent(DineOutEvent.RemoveProductFromCart(cartItem.cartOrder.cartOrderId, it))
                                        },
                                        increaseQuantity = {
                                            dineOutViewModel.onDineOutEvent(DineOutEvent.AddProductToCart(cartItem.cartOrder.cartOrderId, it))
                                        }
                                    )
                                    ...
                                    CartAddOnItems(
                                        ...
                                        onClick = {
                                            dineOutViewModel.onDineOutEvent(DineOutEvent.UpdateAddOnItemInCart(it, cartItem.cartOrder.cartOrderId))
                                        },
                                    )
                                    ...
                                    CartItemTotalPriceSection(
                                        ...
                                        onClickPlaceOrder = {
                                            dineOutViewModel.onDineOutEvent(DineOutEvent.PlaceDineOutOrder(cartItem.cartOrder.cartOrderId))
                                        },
                                        onClickPrintOrder = {
                                            dineOutViewModel.onDineOutEvent(DineOutEvent.PlaceDineOutOrder(cartItem.cartOrder.cartOrderId))
