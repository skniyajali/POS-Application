package com.niyaj.popos.presentation.print_order
    ...
    private fun printOrder(cartOrderId: String) {
        viewModelScope.launch {
            ...
            if (itemDetails != null) {
                ...
                if(itemDetails.cartOrder.doesChargesIncluded && itemDetails.cartOrder.cartOrderType != CartOrderType.DineIn.orderType){
