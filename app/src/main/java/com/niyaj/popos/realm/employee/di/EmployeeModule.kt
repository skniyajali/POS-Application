package com.niyaj.popos.realm.employee.di

import com.niyaj.popos.realm.employee.domain.repository.EmployeeRepository
import com.niyaj.popos.realm.employee.domain.use_cases.CreateNewEmployee
import com.niyaj.popos.realm.employee.domain.use_cases.DeleteEmployee
import com.niyaj.popos.realm.employee.domain.use_cases.EmployeeUseCases
import com.niyaj.popos.realm.employee.domain.use_cases.FindEmployeeByName
import com.niyaj.popos.realm.employee.domain.use_cases.FindEmployeeByPhone
import com.niyaj.popos.realm.employee.domain.use_cases.GetAllEmployee
import com.niyaj.popos.realm.employee.domain.use_cases.GetEmployeeById
import com.niyaj.popos.realm.employee.domain.use_cases.UpdateEmployee
