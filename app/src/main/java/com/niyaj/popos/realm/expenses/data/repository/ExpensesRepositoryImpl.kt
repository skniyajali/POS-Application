package com.niyaj.popos.realm.expenses.data.repository
    ...
    override suspend fun getAllExpenses(): Flow<Resource<List<Expenses>>> {
        return channelFlow {
            try {
                ...
                val expenses = realm.query<Expenses>("created_at >= $0", startDate)
        ...
        return try {
            ...
            realm.write {
                val expenses = if (deleteAll) {
                    ...
                    this.query<Expenses>("created_at < $0", expensesDate).find()
                }
