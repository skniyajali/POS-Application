package com.niyaj.popos.realm.delivery_partner.di

import com.niyaj.popos.realm.delivery_partner.domain.repository.PartnerRepository
import com.niyaj.popos.realm.delivery_partner.domain.use_cases.CreateNewPartner
import com.niyaj.popos.realm.delivery_partner.domain.use_cases.DeletePartner
import com.niyaj.popos.realm.delivery_partner.domain.use_cases.GetAllPartners
import com.niyaj.popos.realm.delivery_partner.domain.use_cases.GetPartnerByEmail
import com.niyaj.popos.realm.delivery_partner.domain.use_cases.GetPartnerById
import com.niyaj.popos.realm.delivery_partner.domain.use_cases.GetPartnerByPhone
import com.niyaj.popos.realm.delivery_partner.domain.use_cases.PartnerUseCases
import com.niyaj.popos.realm.delivery_partner.domain.use_cases.UpdatePartner
