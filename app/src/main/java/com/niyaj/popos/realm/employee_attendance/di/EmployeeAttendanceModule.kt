package com.niyaj.popos.realm.employee_attendance.di

import com.niyaj.popos.realm.employee_attendance.domain.use_cases.AddAbsentEntry
import com.niyaj.popos.realm.employee_attendance.domain.use_cases.AttendanceUseCases
import com.niyaj.popos.realm.employee_attendance.domain.use_cases.DeleteAttendanceByEmployeeId
import com.niyaj.popos.realm.employee_attendance.domain.use_cases.DeleteAttendanceById
import com.niyaj.popos.realm.employee_attendance.domain.use_cases.FindAttendanceByAbsentDate
import com.niyaj.popos.realm.employee_attendance.domain.use_cases.GetAllAttendance
import com.niyaj.popos.realm.employee_attendance.domain.use_cases.GetAttendanceById
import com.niyaj.popos.realm.employee_attendance.domain.use_cases.GetMonthlyAbsentReports
import com.niyaj.popos.realm.employee_attendance.domain.use_cases.UpdateAbsentEntry
