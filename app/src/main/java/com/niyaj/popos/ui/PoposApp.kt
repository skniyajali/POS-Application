...
import com.niyaj.popos.MainViewModel
import com.niyaj.popos.navigation.PoposNavigation
...
fun PoposApp(
    ...
    val destination = if (isLoggedIn) HomeNavGraph else HomeNavGraph
